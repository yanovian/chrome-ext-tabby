...
const FALLBACK_LINES: Record<SpeechKind, string[]> = {
  ...
  hungry: [
    'I’m a little hungry. Find anything fun today?',
    'Peckish — got something good to read?',
    'My tummy wants a fun new page.',
    'Still hungry for something interesting.',
    'Mrrp. I could use a snack-sized read.',
    'Hungry whiskers — point me at something fun.',
    'I’m peckish. Got a page worth pouncing on?',
    'Mew — hungry for something new to explore.',
    'Running low on snacks. What should we read?',
  ],
  stressed: [
